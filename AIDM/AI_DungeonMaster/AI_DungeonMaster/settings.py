"""
Django settings for AI_DungeonMaster project.
...
SECRET_KEY = 'django-insecure-e@2+8dlpsys5@1ng2_gw+omtkuf=s!k8@j96470!-z#n_00%rh'
...
WSGI_APPLICATION = 'AI_DungeonMaster.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'Infinite_Questmaster', 'static'),
     os.path.join(BASE_DIR, 'new_static_directory'),
]
